...
import { PurchaserContainer, Purchaser, Name, Details, Image, Mobile } from "./LegalHeirFormStyle"
...
const LegalHeirForm = props => {
    ...
    /* watching transferApplicationFetchState to check whther we need to display Add-primary-purchaser-button or not */
